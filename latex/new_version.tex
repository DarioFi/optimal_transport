...
\begin{document}
    ...
    \subsubsection{Lemma 12.15 \cite{Bernot}}
    ...
    We can improve the results from the book for the case described by figure \ref{fig:angle_bound_example_inverted}.
    ...
    I left them on the jupyter notebook, I am unsure on how to generate masses and what numbers to use to generate tests.
