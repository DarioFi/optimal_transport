...
\begin{document}
    ...
    The key point is the supports of the paths taken by particles in optimal traffic plans exhibit a graph structure. This property is crucial for
