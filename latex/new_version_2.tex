...
\begin{document}
    ...
    {\color{teal} Alternatively we can define it with the other formulation, which are currents. The following will be less formal
    as I am not that familiar with the subject but we know from \cite{Bernot} that the two formulations are equivalent.}
